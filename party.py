...
def most_and_least_common_type(treats):
    ...
    # Give me a sorted list of get_treats
    #     if the list is empty, tell me. or if the list has stuff
    #         Tell me how many of what type of thing. 

    #     if the list is empty, tell me. of if  the list has stuff
    #         Tell me  how many of what type of thing.
